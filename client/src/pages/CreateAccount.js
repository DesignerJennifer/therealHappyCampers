...
import CamperRegForm from './CamperRegForm.js'
...
const handleNext = () => {
    ...
    //     const { firstName, lastName, password, email, phoneNumber, address, city, state, zip } = this.state;

    //     const path = axios.post('/api/signup/', firstName, lastName, password, email, phoneNumber, address, city, state, zip)
    //         .then((results) => {
    //             console.log(results);
    //         });
};
